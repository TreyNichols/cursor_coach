...
def Wrist_Stretch():
    ...
    wrist_stretch = Button(
        ...
        text_input = "1. Put elbow on flat surface and push wrist down", font = get_font(20), base_color = "blue", hovering_color = "blue"
        )
    wrist_stretch_2 = Button(
        image = pygame.transform.scale_by(pygame.image.load("assets/wrist_flex_2.png"), .6), pos = (650, 400),
        text_input = "2. Put elbow on flat surface and push wrist up", font = get_font(20), base_color = "blue", hovering_color = "blue"
        )
    while True:
        SCREEN.fill('white')
        cursor_pos = (c.rect.x, c.rect.y)
...
def Thumb_Stretch():
    ...
    thumb_wrist_stretch = Button(
        ...
        text_input = "1. Tuck thumb and gently flex down", font = get_font(20), base_color = "black", hovering_color = "black"
        )
    while True:
        SCREEN.fill('white')
        cursor_pos = (c.rect.x, c.rect.y)
...
def Finger_Stretch():
    ...
    finger_flex_up = Button(
        ...
        text_input = "1. Flex Each finger upward", font = get_font(20), base_color = "black", hovering_color = "black"
        )
    finger_flex_down = Button(
        image = pygame.transform.scale_by(pygame.image.load("assets/finger_flex_down.png"), 1.15), pos = (950, 200),
        text_input = "2. Flex Each finger downward", font = get_font(20), base_color = "black", hovering_color = "black"
        )
    while True:
        SCREEN.fill('white')
        cursor_pos = (c.rect.x, c.rect.y)
...
def Forearm_Stretch():
    ...
    wrist_stretch_up = Button(
        ...
        text_input = "1. Flex Wrist Upward", font = get_font(20), base_color = "black", hovering_color = "black"
        )
    
    wrist_stretch_down = Button(
        image = pygame.transform.scale_by(pygame.image.load("assets/wrist_flex_down.png"), .8), pos = (950, 150),
        text_input = "2. Flex Wrist Downward", font = get_font(20), base_color = "black", hovering_color = "black"
        )
    while True:
        SCREEN.fill('white')
        cursor_pos = (c.rect.x, c.rect.y)
